...
# --- NEW: set up data folder & log file relative to project root ---
BASE_DIR = Path(__file__).resolve().parents[1]   # realtime-anomaly-detection
...
def main():
    ...
    while True:
        ...
        # mirror to local file for training
        with LOG_FILE.open("a") as f:
            f.write(json.dumps(tx) + "\n")

        print("Produced:", tx["transaction_id"], tx["amount"])
